...
Device-plane watchdog for the VSLAM stack. Watches `camera_info` rate of the front D435 (infra1+infra2) and VO cadence, classifies which layer broke, hardware-resets a wedged camera one at a time.
