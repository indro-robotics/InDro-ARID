...
for _lib in system network container; do
...
collect_answers() {
    ...
    ask_yn "  Assign the three RealSense cameras (front/left/right) into vslam_config.yaml? (y/n, Enter = skip): " n \
...
#   .arid_setup_continue -> re-enter the tail (run_step skips finished sections), armed by
