...
# Ensure no changes to config folders, unsure where local configs will fall on V3
# git update-index --assume-unchanged ${LOCAL_WS}/src/csi_drone_camera/gst_camera_info/config/ ${LOCAL_WS}/src/apriltag_cypher/cfg/
